Contributing to ALNJ Core
============================

The ALNJ Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/alnjl-project/alnjl/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ALNJ Core project, and is not to be
confused with overall ALNJ Network Protocol consensus changes.

Whether a pull request is merged into ALNJ Core rests with the project merge
...
Patches that change ALNJ consensus rules are considerably more involved than
...
Where a patchset proposes to change the ALNJ consensus, it must have been
...
The project leader is the release manager for each ALNJ Core release.
