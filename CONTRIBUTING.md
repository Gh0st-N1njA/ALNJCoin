Contributing to PCTM Core
============================

The PCTM Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Gh0st-N1njA/PactumCoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PCTM Core project, and is not to be
confused with overall PCTM Network Protocol consensus changes.

Whether a pull request is merged into PCTM Core rests with the project merge
...
Patches that change PCTM consensus rules are considerably more involved than
...
Where a patchset proposes to change the PCTM consensus, it must have been
...
The project leader is the release manager for each PCTM Core release.
