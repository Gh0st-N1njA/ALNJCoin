...
-------
    ...
    ./src/alnjd -daemon # Starts the alnj daemon.
    ./src/alnj-cli --help # Outputs a list of command-line options.
    ./src/alnj-cli help # Outputs a list of RPC commands when the daemon is running.
