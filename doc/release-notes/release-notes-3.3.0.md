ALNJ Core version *3.3.0* is now available from:  <https://github.com/alnjl-project/alnjl/releases>
...
Moving forward from this undesired situation, we are enabling a secure and chain storage friendly solution for the zerocoin public spend (aka zPIV to ALNJ conversion).
