...
PCTM Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
...
zPCTM stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by PCTM stakers.
...
### Show progress percent for zpctm reindex operations
...
### Core Features
 ...
 - #609 `6b73598b9` [MoveOnly] Remove zPCTM code from main.cpp (presstab)
...
### GUI
 ...
 - #600 `217433561` [GUI] Only enable/disable PrivacyDialog zPCTM elements if needed. (presstab)
 - #612 `6dd752cb5` [Qt] Show progress percent for zpctm reindex operations (Fuzzbawls)
...
### Wallet
 ...
 - #603 `779d8d597` Fix spending for v1 zPCTM created before block 1050020. (presstab)
