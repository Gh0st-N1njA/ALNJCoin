ALNJ Core version *3.2.0* is now available from:  <https://github.com/alnjl-project/alnjl/releases>
...
A full report provided by ALNJ developers is available on the [ALNJ Website](https://alnjlite.com/fake-stake-official-alnjl-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://alnjlite.com/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
