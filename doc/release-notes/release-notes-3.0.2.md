...
Users that wish to prevent this behavior (not recommended) can pass `-backupzpctm=0` at the command-line when starting the client, or add `backupzpctm=0` to their `pctm.conf` file.
