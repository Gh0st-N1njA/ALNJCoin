...
Users that wish to prevent this behavior (not recommended) can pass `-backupzalnj=0` at the command-line when starting the client, or add `backupzalnj=0` to their `pivx.conf` file.
