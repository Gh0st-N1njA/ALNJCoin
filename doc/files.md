...
alnj.conf           | contains configuration settings for alnjd or alnj-qt
alnjd.pid           | stores the process id of alnjd while running
...
debug.log           | contains debug information and general logging generated by alnjd or alnj-qt
