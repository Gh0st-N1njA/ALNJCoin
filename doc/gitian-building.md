...
*Setup instructions for a gitian build of PCTM Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the PCTM
...
to the PCTM GitHub release page.
...
- [Building PCTM Core](#building-pctm-core)
...
[gitian.sigs](https://github.com/pctm-project/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@pctm.org) and he will commit them.
