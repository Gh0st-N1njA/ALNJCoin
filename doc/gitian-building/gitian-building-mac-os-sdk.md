...
The script [extract-osx-sdk.sh](https://github.com/Gh0st-N1njA/PactumCoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
pctm/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Gh0st-N1njA/PactumCoin/blob/master/doc/README_osx.md) for troubleshooting tips.