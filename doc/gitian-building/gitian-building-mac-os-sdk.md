...
The script [extract-osx-sdk.sh](https://github.com/alnj-project/alnj/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
alnj/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/alnj-project/alnj/blob/master/doc/README_osx.md) for troubleshooting tips.