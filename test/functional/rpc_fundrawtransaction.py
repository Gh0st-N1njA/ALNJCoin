...
class RawTransactionsTest(PctmTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid pctm address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid pctm address" in e.error['message'])
