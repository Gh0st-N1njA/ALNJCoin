...
from test_framework.pctm_node import PctmTestNode
...
class PCTM_ColdStakingTest(PctmTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(PctmTestNode())
