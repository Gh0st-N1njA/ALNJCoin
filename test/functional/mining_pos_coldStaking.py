...
from test_framework.alnj_node import AlnjTestNode
...
class ALNJ_ColdStakingTest(AlnjTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(AlnjTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 ALNJ from the pot)
