...
"""Verify that starting alnj with -h works as expected."""
import subprocess

from test_framework.test_framework import AlnjTestFramework
from test_framework.util import assert_equal

class HelpTest(AlnjTestFramework):
    ...
    def run_test(self):
        self.log.info("Start alnj with -h for help text")
        ...
        self.log.info("Start alnj with -version for version information")
