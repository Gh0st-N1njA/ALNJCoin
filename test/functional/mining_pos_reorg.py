...
class ReorgStakeTest(PctmTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpctm):
        ...
        for node in g_info:
            ...
            for denom in node['zPCTMsupply']:
                assert_equal(node['zPCTMsupply'][denom], DecimalAmt(expected_zpctm[denom]))
    ...
    def run_test(self):
        ...
        expected_zpctm_supply[str(spent_coin_0)] -= spent_coin_0
        expected_zpctm_supply[str(spent_coin_1)] -= spent_coin_1
        expected_zpctm_supply["total"] -= (spent_coin_0 + spent_coin_1)
        self.check_money_supply(expected_money_supply, expected_zpctm_supply)
