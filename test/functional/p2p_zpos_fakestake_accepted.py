...
from fake_stake.base_test import ALNJ_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(ALNJ_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zalnjstake']] * self.num_nodes
