...
#include "qt/pctm/sendchangeaddressdialog.h"
#include "qt/pctm/forms/ui_sendchangeaddressdialog.h"
    ...
    ui(new Ui::SendChangeAddressDialog)
{
    ...
    ui->labelMessage->setText(tr("The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" PCTM address"));
    ui->labelMessage->setProperty("cssClass", "text-main-grey");

    ui->lineEditAddress->setPlaceholderText("Enter PCTM address (e.g D7VFR83SQbiezrW72hjc… ");
