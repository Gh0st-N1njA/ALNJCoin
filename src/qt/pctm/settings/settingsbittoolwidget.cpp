...
SettingsBitToolWidget::SettingsBitToolWidget(PCTMGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("PCTM address"));
