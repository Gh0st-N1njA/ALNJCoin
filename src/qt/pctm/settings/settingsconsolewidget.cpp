...
#include "qt/pctm/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/pctm/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PCTMGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory){
    ...
    message(CMD_REPLY, (tr("Welcome to the PCTM RPC console.") + "<br>" +
