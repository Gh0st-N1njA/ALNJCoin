...
QT_TRANSLATE_NOOP("alnj-core", "(8233 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("alnj-core", "(default: %s)"),
QT_TRANSLATE_NOOP("alnj-core", "(default: 1)"),
QT_TRANSLATE_NOOP("alnj-core", "(must be 8233 for mainnet)"),
...
QT_TRANSLATE_NOOP("alnj-core", "Adding Wrapped Serials supply..."),
...
QT_TRANSLATE_NOOP("alnj-core", "Calculating missing accumulators..."),
QT_TRANSLATE_NOOP("alnj-core", "Cannot create public spend input"),
QT_TRANSLATE_NOOP("alnj-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("alnj-core", "Cannot resolve -bind address: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Cannot resolve -externalip address: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Cannot resolve -whitebind address: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "CoinSpend: Accumulator witness does not verify"),
QT_TRANSLATE_NOOP("alnj-core", "CoinSpend: failed check"),
...
QT_TRANSLATE_NOOP("alnj-core", "Couldn't generate the accumulator witness"),
...
QT_TRANSLATE_NOOP("alnj-core", "Enable automatic Zerocoin minting (0-1, default: %u)"),
QT_TRANSLATE_NOOP("alnj-core", "Enable precomputation of zPIV spends and stakes (0-1, default %u)"),
...
QT_TRANSLATE_NOOP("alnj-core", "Failed to calculate accumulator checkpoint"),
QT_TRANSLATE_NOOP("alnj-core", "Failed to create mint"),
...
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("alnj-core", "Invalid amount for -reservebalance=<amount>"),
...
QT_TRANSLATE_NOOP("alnj-core", "Loading wallet... (%3.2f %%)"),
...
QT_TRANSLATE_NOOP("alnj-core", "Percentage of automatically minted Zerocoin  (1-100, default: %u)"),
...
QT_TRANSLATE_NOOP("alnj-core", "Recalculating minted ZPIV..."),
QT_TRANSLATE_NOOP("alnj-core", "Recalculating spent ZPIV..."),
QT_TRANSLATE_NOOP("alnj-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("alnj-core", "Reindex the ALNJ and zPIV money supply statistics"),
QT_TRANSLATE_NOOP("alnj-core", "Reindex the accumulator database"),
...
QT_TRANSLATE_NOOP("alnj-core", "Session timed out."),
...
QT_TRANSLATE_NOOP("alnj-core", "Signing timed out."),
...
QT_TRANSLATE_NOOP("alnj-core", "Support the zerocoin light node protocol (default: %u)"),
...
QT_TRANSLATE_NOOP("alnj-core", "Synchronization pending..."),
...
QT_TRANSLATE_NOOP("alnj-core", "The coin spend has been used"),
QT_TRANSLATE_NOOP("alnj-core", "The transaction did not verify"),
...
QT_TRANSLATE_NOOP("alnj-core", "could not get lock on cs_spendcache"),
