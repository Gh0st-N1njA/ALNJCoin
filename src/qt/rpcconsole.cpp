                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPIVPathCustom = GetArg("-zalnjbackuppath", "");
    ...
    if(!strzPIVPathCustom.empty()) {
        ui->wallet_customzalnjbackuppath->setText(QString::fromStdString(strzPIVPathCustom));
        ui->wallet_customzalnjbackuppath_label->setVisible(true);
        ui->wallet_customzalnjbackuppath->setVisible(true);
    }
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ALNJ RPC console.") + "<br>" +
