...
#include "qt/alnjl/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/alnjl/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ALNJGUI* _window, QWidget *parent) :
