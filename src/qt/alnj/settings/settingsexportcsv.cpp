...
#include "qt/alnj/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(ALNJGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ALNJ_tx_csv_export(*.csv)") : tr("ALNJ_addresses_csv_export(*.csv)"),
                                        nullptr);
