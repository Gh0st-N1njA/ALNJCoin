    ...
    ui(new Ui::DashboardWidget)
{
    ...
    setCssProperty(ui->labelZpiv, "text-chart-zalnj");
    ...
    ui->labelAmountZpiv->setText("0 zALNJ");
    ui->labelAmountPiv->setText("0 ALNJ");
    setCssProperty(ui->labelAmountPiv, "text-stake-piv-disable");
    setCssProperty(ui->labelAmountZpiv, "text-stake-zalnj-disable");
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy()
{
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZALNJ;
...
void DashboardWidget::onChartRefreshed()
{
    ...
    if (chartData->totalPiv > 0 || chartData->totalZpiv > 0) {
        ...
        setCssProperty(ui->labelAmountZpiv, "text-stake-zalnj");
    } else {
        setCssProperty(ui->labelAmountPiv, "text-stake-piv-disable");
        setCssProperty(ui->labelAmountZpiv, "text-stake-zalnj-disable");
    }
