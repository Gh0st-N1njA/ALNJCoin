...
#include "qt/alnjl/coincontrolalnjwidget.h"
#include "qt/alnjl/forms/ui_coincontrolalnjwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select ALNJ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ALNJ");
    ...
    ui->labelValueAfter->setText("0.00 ALNJ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ALNJ");
    ui->labelValueFee->setText("0.00 ALNJ");
