...
QString BitcoinUnits::id(int unit)
{
    ...
    case PCTM:
        return QString("pctm");
    case mPCTM:
        return QString("mpctm");
    case uPCTM:
        return QString::fromUtf8("upctm");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPCTM)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZPCTM);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPCTM)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZPCTM));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
