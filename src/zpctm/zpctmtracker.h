...
#ifndef PCTM_ZPCTMTRACKER_H
#define PCTM_ZPCTMTRACKER_H
...
public:
    CzPCTMTracker(CWallet* parent);
    ~CzPCTMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPCTMWallet* zPCTMWallet = NULL);
