...
#ifndef PCTM_ZPCTMWALLET_H
#define PCTM_ZPCTMWALLET_H
...
public:
    ...
    void GenerateDeterministicZPCTM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPCTM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
