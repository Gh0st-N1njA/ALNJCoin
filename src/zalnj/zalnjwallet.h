...
#ifndef ALNJ_ZALNJWALLET_H
#define ALNJ_ZALNJWALLET_H
...
public:
    ...
    void GenerateDeterministicZALNJ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZALNJ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
