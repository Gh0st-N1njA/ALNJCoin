...
extern UniValue setzpctmseed(const UniValue& params, bool fHelp);
extern UniValue getzpctmseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpctm(const UniValue& params, bool fHelp);
extern UniValue dzpctmstate(const UniValue& params, bool fHelp);
