...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PCTM features */
        {"pctm", "listmasternodes", &listmasternodes, true, true, false},
        {"pctm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pctm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pctm", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pctm", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pctm", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pctm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pctm", "masternodedebug", &masternodedebug, true, true, false},
        {"pctm", "startmasternode", &startmasternode, true, true, false},
        {"pctm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pctm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pctm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pctm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pctm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pctm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pctm", "preparebudget", &preparebudget, true, true, false},
        {"pctm", "submitbudget", &submitbudget, true, true, false},
        {"pctm", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pctm", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pctm", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pctm", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pctm", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pctm", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pctm", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pctm", "checkbudgets", &checkbudgets, true, true, false},
        {"pctm", "mnsync", &mnsync, true, true, false},
        {"pctm", "spork", &spork, true, true, false},
        ...
        {"zerocoin", "getzpctmseed", &getzpctmseed, false, false, true},
        {"zerocoin", "setzpctmseed", &setzpctmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpctm", &searchdzpctm, false, false, true},
        {"zerocoin", "dzpctmstate", &dzpctmstate, false, false, true},
...
{
    return "> pactumcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12123/\n";
}
