 ...
 * ALNJ system. There are three: the main network on which people trade goods
...
public:
    ...
    int AlnjBadBlockTime() const { return nAlnjBadBlockTime; }
    int AlnjBadBlocknBits() const { return nAlnjBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nAlnjBadBlockTime;
    unsigned int nAlnjBadBlocknBits;
