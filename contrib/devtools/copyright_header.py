...
Arguments:
    <base_directory> - The base directory of a pctm source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The PCTM developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The PCTM developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The PCTM developers" at the top of the
...
If the file already has a copyright for "The PCTM developers", the
script will exit.
