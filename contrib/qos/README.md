...
This means one can have an always-on alnjd instance running, and another local alnjd/alnj-qt instance which connects to this node and receives blocks from it.
